...
class _LoginPageState extends State<LoginPage> {
  ...
  Future<void> _submit() async {
    ...
    if (_selectedRole == "Aluno") {
      url = Uri.http('192.168.0.163:5000', '/LoginAluno');
    } else if (_selectedRole == "Professor") {
      url = Uri.http('192.168.0.163:5000',
          '/LoginProfessor'); //TODO: CRIAR ESSE ENDPOINT em login_manager.py
    }
  ...
  void saveNameToPrefs(String name) async {
                  ...
                  Form(
                    ...
                    child: Column(children: [
                      ...
                      DropdownButton<String>(
                        ...
                        items:
                            <String>['Aluno', 'Professor'].map((String value) {
